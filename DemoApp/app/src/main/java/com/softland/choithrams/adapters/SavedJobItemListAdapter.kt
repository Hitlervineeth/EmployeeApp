...
class SavedJobItemListAdapter(context: Context) : RecyclerView.Adapter<SavedJobItemListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context).inflate(R.layout.layout_recycler_view_saved_job_item_object, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.expiry_date.text=itemdetails.ExpiryDate.split("T")[0].toString()
